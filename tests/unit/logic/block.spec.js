...
describe("logic/block", function() {
    var dummyBlock, dummyTransactions, callback, transaction, block, data, config;
    ...
    beforeEach(function() {
        ...
        instance = new Block.BlockLogic(config);
    });
    ...
    describe("class", function() {
        ...
        it("block is an object", function() {
            expect(instance).to.be.an.instanceof(Object);
        });
    });
    ...
    describe("[static] verifySignature", function() {
        it("returns a verified hash", function() {
            expect(instance.verifySignature(dummyBlock))
                .to.be.an.true;
        });
    });
