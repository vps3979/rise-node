...
import {constants, ILogger, JobsQueue, promiseToCB} from "./../../../src/helpers/";
...
describe("logic/broadcaster", () => {
    ...
    let JobsQueueStub : any; 

    before(() => {
        JobsQueueStub = sandbox.stub(JobsQueue, "register");
    });
    ...
    beforeEach(() => {
        library = {
            ...
            logic : {
                ...
                transactions : {
                    assertNonConfirmed : sandbox.stub()
                }
            },
            config : {
                broadcasts : {
        ...
        modules = {
            ...
            transactions : {
                transactionInPool : sandbox.stub()
            }
        };

        instance = new BroadcasterLogic(library);
        instance.bind(modules.peers, modules.transport, modules.transactions);
    });
